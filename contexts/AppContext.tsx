...
یک پرامپت (دستور) دقیق و خلاقانه برای یک مدل تولید تصویر بر اساس این عکس بنویس.
- موضوع اصلی، حالت بدن و احساسات را توصیف کن.
- یک سبک هنری "هایپررئالستیک" با "نورپردازی سینمایی و دراماتیک" را پیشنهاد بده.
- محیط را با جزئیات بیشتر و اتمسفری قوی‌تر تصور کن.
- پرامپت نهایی باید به زبان انگلیسی و بسیار دقیق باشد.
- فقط و فقط پرامپت نهایی را برگردان و هیچ متن اضافه تری ننویس
`.trim();
